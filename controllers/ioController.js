...
module.exports = function(app, io){//stores app and io var received from main chatController
    ...
    io.on('connection', function(socket){//Everything from this point happens as long as there is a socket connection between the client and server
        ...
        socket.on('chat message', function(msg){
            ...
            io.to(msg.room).emit('chat message', msg);//forwards the message received from the client to everyone in the same room as of client
        });
        //xxx
